...
total_group = bits_num / bits_per_group;
 ...
 ds_train_file = './datasets/train_labels.mat';
 disp('load dataset...');
 temp_train=load(ds_train_file);
     
 train_datapath = '/home/bohan/Documents/code/fasthash/data/cifar_10/preprocessed_data/train_hkl/';
% 
