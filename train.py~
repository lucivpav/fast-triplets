...
def train_net(config):
   ...
   # load hash_step1_bits
    group_idx = sio.loadmat('/home/bohan/Documents/code/cvpr/triplet/cifar_10/step1/temp/group_idx.mat')
    ...
    for idx in bits_idxes:
        ...
        hash_step1_code = h5py.File('/home/bohan/Documents/code/cvpr/triplet/cifar_10/step1/temp/hash_step1_code_' + str(idx + 1) + '.mat')
...
#            for param_i in params]
    ...
    sio.savemat('/home/bohan/Documents/code/cvpr/triplet/cifar_10/temp/hash_step2_code_' + str(group_idx - 1) + '.mat', hash_step2_code) 
